...
mod tests {
    ...
    // https://www.codewars.com/kata/54d512e62a5e54c96200019e/solutions/rust:w
    // Nothing special in solutions, the first one does factorisation + push format everythime it
